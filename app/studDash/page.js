...
const StudentDashboard = () => {
  ...
  useEffect(() => {
    const fetchStudentInfo = async () => {
      try {
        const response = await axios.get('http://localhost/attendance/studentInfo.php', {
    ...
    const fetchAttendanceData = async () => {
      setLoading(true);
      try {
        const response = await axios.get('http://localhost/attendance/studentAttendance.php', {
          withCredentials: true,
        });
