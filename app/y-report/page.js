...
const AttendanceByYear = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('http://localhost/attendance/getAttendanceByYear.php');
        ...
        setError(error.message || 'There was an error fetching year level attendance data.');
      }
    };
