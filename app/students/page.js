...
const StudentForm = () => {
  ...
  useEffect(() => {
    ...
    const fetchRecords = async () => {
      try {
        const response = await fetch('http://localhost/attendance/getStudentRecords.php', {
          method: 'GET',
          headers: {
            'Content-Type': 'application/json',
          },
  ...
  const handleStudentSubmit = async () => {
    setLoading(true);
    try {
      const response = await fetch('http://localhost/attendance/saveStudentDetails.php', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      if (response.ok) {
        ...
        const updatedRecords = await fetch('http://localhost/attendance/getStudentRecords.php')
  ...
  const handleTribuSubmit = async (values) => {
    setLoading(true);
    try {
      const response = await fetch('http://localhost/attendance/saveTribuType.php', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      if (response.ok) {
        ...
        const updatedTribuOptions = await fetch('http://localhost/attendance/getTribuOptions.php')
          .then((response) => response.json())
          .then((result) => (response.ok ? result : []));
